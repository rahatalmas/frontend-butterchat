...
export const Icons = {
  ...
  Project: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>,
  Article: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
  Market: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>,
  Chat: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
  Heart: ({filled}) => <svg viewBox="0 0 24 24" fill={filled?"#ff6b9d":"none"} stroke={filled?"#ff6b9d":"currentColor"} strokeWidth="2" className="w-5 h-5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>,
  Comment: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>,
  ...
  Bookmark: ({filled}) => <svg viewBox="0 0 24 24" fill={filled?"#64d9ff":"none"} stroke={filled?"#64d9ff":"currentColor"} strokeWidth="2" className="w-5 h-5"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>,
  ...
  Star: ({filled}) => <svg viewBox="0 0 24 24" fill={filled?"#ffd93d":"none"} stroke={filled?"#ffd93d":"currentColor"} strokeWidth="2" className="w-4 h-4"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/></svg>,
  Git: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>,
  Terminal: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4"><polyline points="4,17 10,11 4,5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>,
...
// Sample Data
export const posts = [
  { id: 1, type: 'project', author: { name: 'Sarah Chen', avatar: '👩‍💻', username: '@sarahcodes', verified: true }, title: 'Built a VS Code Extension for AI Code Review', content: 'Finally shipped my first VS Code extension! It uses GPT-4 to review your code and suggest improvements. 🚀', tags: ['TypeScript', 'VSCode', 'AI'], likes: 234, comments: 45, time: '2h ago', codeSnippet: `const reviewCode = async (code) => {\n  const response = await openai.analyze(code);\n  return response.suggestions;\n};` },
  { id: 2, type: 'article', author: { name: 'Alex Rivera', avatar: '🧑‍💻', username: '@alexdev', verified: false }, title: 'Why I Switched from React to Svelte', content: 'After 3 years of React, I made the switch to Svelte. Here\'s what I learned...', tags: ['Svelte', 'React', 'Frontend'], likes: 567, comments: 89, time: '5h ago', readTime: '8 min' },
  { id: 3, type: 'gig', author: { name: 'Mike Johnson', avatar: '👨‍💻', username: '@mikej', verified: true }, title: 'Need help with Python script automation', content: 'Looking for someone to help automate my data pipeline. Should take about 2-3 hours.', tags: ['Python', 'Automation'], budget: '$50', time: '1h ago', status: 'open', applicants: 3 },
  { id: 4, type: 'discussion', author: { name: 'Emma Wilson', avatar: '👩‍🎨', username: '@emmacodes', verified: false }, title: 'What\'s your favorite terminal setup?', content: 'I\'m using iTerm2 + Oh My Zsh + Powerlevel10k. What\'s everyone else using? ✨', tags: ['Terminal', 'Setup'], likes: 123, comments: 67, time: '3h ago' },
];

export const gigs = [
  { id: 1, title: 'Fix React Native bug', budget: '$25', deadline: '2 days', skills: ['React Native', 'iOS'], urgent: true, applicants: 5 },
  { id: 2, title: 'Build REST API endpoint', budget: '$100', deadline: '1 week', skills: ['Node.js', 'MongoDB'], urgent: false, applicants: 12 },
  { id: 3, title: 'Code Review for startup', budget: '$75', deadline: '3 days', skills: ['Python', 'Django'], urgent: false, applicants: 8 },
  { id: 4, title: 'Landing page design', budget: '$150', deadline: '5 days', skills: ['React', 'Tailwind'], urgent: true, applicants: 15 },
];

export const trendingTags = ['#React', '#TypeScript', '#AI', '#WebDev', '#Python', '#Rust', '#NextJS', '#TailwindCSS'];
